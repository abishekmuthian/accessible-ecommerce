      ...
      <div className="bg-ui-light pb-12 lg:pb-0 w-full px-4 sm:px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row items-center max-w-screen-2xl mx-auto">
          <StaticImage
            ...
            alt="A black hoodie, Red lipstic and a pink vintage fragrance dispenser"
            placeholder="tracedSVG"
            className="w-full lg:w-1/2 h-auto"
          />
          <div>
            <h1 className="text-4xl">Accessible eCommerce</h1>
            <p className="mt-2 text-lg font-normal">
              A functional mock fashion & beauty e-commerce store
              <br />
